...
#define _FUNC_DEF		(id_func_num) 	CreateNode(FUNCTION_DEFINITION, 	{.val_func_def  = id_func_num}, 	NULL, NULL,  NULL)
#define _PARAM			() 				CreateNode(PARAMETERS, 				{}, 								NULL, NULL,  NULL)
#define _VAR_DECL		(var_id) 		CreateNode(VAR_DECLARATION, 		{.val_decl_var	= var_id}, 			NULL, NULL,  NULL)
#define _CALL			() 				CreateNode(CALL, 					{},					 				NULL, NULL,  NULL)
...
#define _PRINTF			() 				CreateNode(KEYWORD,  				{.val_key_word = PRINTF}, 			NULL, NULL,  NULL)
#define _RETURN			() 				CreateNode(KEYWORD,  				{.val_key_word = RETURN}, 			NULL, NULL,  NULL)
